"""
Compare candidate generation strategies in OQBoost research prototype:
1. random_only: i.i.d. sparse random projections (control group)
2. cache_fifo: C++ FIFO cache (control group)
3. cache_pca: PCA-based Subspace Learning Cache
4. cache_lineage_orth: FIFO cache orthogonalized against path lineage vectors
...
def run_experiment(X_tr, y_tr, X_te, y_te, dataset_name, n_seeds=5):
    ...
    configs = [
        {"name": "random_only", "inherit_mode": "random_only"},
        {"name": "cache_fifo", "inherit_mode": "cache_blend"},
        {"name": "cache_pca", "inherit_mode": "cache_pca"},
        {"name": "cache_lineage_orth", "inherit_mode": "cache_lineage_orth"},
        {"name": "pobs", "inherit_mode": "pobs"},
        {"name": "qmc", "inherit_mode": "qmc"},
    ]
    results = {}
...
def main():
    ...
    for dataset, res in all_results.items():
        for name in ["random_only", "cache_fifo", "cache_pca", "cache_lineage_orth", "pobs", "qmc"]:
