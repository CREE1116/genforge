"""
Compare child direction mutation strategies:
1. noise_less: Decaying noise scale mutation (inherit_mode='noise_mutation', noise_strategy='less')
2. cosine_constrained: Cosine similarity constrained mutation (inherit_mode='cosine_constrained', budget_strategy='uniform')
3. cosine_constrained_less_budget: Cosine similarity constrained mutation with decaying candidate budget (budget_strategy='less')
"""
...
def run_experiment(X_tr, y_tr, X_te, y_te, dataset_name, n_seeds=3):
    ...
    # We define the strategies configuration
    configs = [
        {"name": "noise_less", "inherit_mode": "noise_mutation", "noise_strategy": "less", "budget_strategy": "uniform"},
        {"name": "cosine_constrained", "inherit_mode": "cosine_constrained", "noise_strategy": "uniform", "budget_strategy": "uniform"},
        {"name": "cosine_constrained_less_budget", "inherit_mode": "cosine_constrained", "noise_strategy": "uniform", "budget_strategy": "less"},
    ]
    results = {}
...
def main():
    ...
    for dataset, res in all_results.items():
        for name in ["noise_less", "cosine_constrained", "cosine_constrained_less_budget"]:
