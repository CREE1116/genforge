"""
Compare adaptive child direction mutation strategies:
1. cosine_depth_less: Depth-based cosine constraints, decaying budget (control baseline)
2. cosine_adaptive_size: Node sample-ratio-based adaptive cosine constraints, decaying budget
3. cosine_adaptive_gradient: Gradient-variance-based adaptive cosine constraints, decaying budget
"""
...
def run_experiment(X_tr, y_tr, X_te, y_te, dataset_name, n_seeds=3):
    ...
    configs = [
        {"name": "cosine_depth_less", "inherit_mode": "cosine_constrained", "budget_strategy": "less"},
        {"name": "cosine_adaptive_size", "inherit_mode": "cosine_adaptive_size", "budget_strategy": "less"},
        {"name": "cosine_adaptive_gradient", "inherit_mode": "cosine_adaptive_gradient", "budget_strategy": "less"},
    ]
    results = {}
...
def main():
    ...
    for dataset, res in all_results.items():
        for name in ["cosine_depth_less", "cosine_adaptive_size", "cosine_adaptive_gradient"]:
