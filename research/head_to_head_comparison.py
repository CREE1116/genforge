...
1. noise_less: Decaying noise scale mutation (inherit_mode='noise_mutation', noise_strategy='less', budget_strategy='uniform')
2. adaptive_size_density: Sample-ratio adaptive cosine constraints, density-preserving budget (inherit_mode='cosine_adaptive_size', budget_strategy='density')
"""
...
def run_experiment(X_tr, y_tr, X_te, y_te, dataset_name, n_seeds=5):
    ...
    configs = [
        {"name": "noise_less", "inherit_mode": "noise_mutation", "noise_strategy": "less", "budget_strategy": "uniform"},
        {"name": "adaptive_size_density", "inherit_mode": "cosine_adaptive_size", "noise_strategy": "uniform", "budget_strategy": "density"},
    ]
    results = {}
...
def main():
    ...
    for dataset, res in all_results.items():
        for name in ["noise_less", "adaptive_size_density"]:
